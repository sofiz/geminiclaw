...
| :--- | :--- | :--- | :--- |
| **Real-time Thought Streaming** | **Word-by-word streaming** of reasoning deltas via WebSockets directly into active UI panels. | Wait-for-completion | **No more "black box" syndrome**. Operators see *exactly* what the model is thinking *as it thinks*, enabling instant detection of hallucination or logic loops. |
